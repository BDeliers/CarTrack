...
private:
    ...
    static constexpr const char* SIM7000_OPCODES[SIM700_CMDSET_LEN] = {
        ...
        "CIPPING",      // PING_SEND_IPV4
        "CCOAPINIT",    // COAP_CREATE_OBJECT
        "CCOAPTERM",    // COAP_DELETE_OBJECT
        "CCOAPACTION",  // COAP_OPERATE_OBJECT
        "CCOAPURL",     // COAP_CONFIGURE_URL
        "CCOAPPARA",    // COAP_ASSEMBLE_DATA_PACKET
    };
